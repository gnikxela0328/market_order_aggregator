class DataCollection():
  ...
  """
  ITERATION ONE OF DATA COLLECTION METHODS
  """
  ...
  """
  ITERATION TWO OF DATA COLLECTION METHODS
  """
  # find bid ask spread for level 5
  def calc_bid_ask_spread_5(row):
    difference = abs(row['ap4'] - row['bp4'])
    return difference
