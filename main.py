...
# supply name of daily input csv to program
input_name = sys.argv[1]
day_input = pd.read_csv(input_name)
day_output = input_name.split("/")[2] + "_aggregate_output.csv"
...
output_df.to_csv("data/output/" + day_output, index=False)
